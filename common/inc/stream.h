 ...
 * stream.h
 *
 *  Packets according to the HOST controller interface Three wire transport
 * layer.
 *
 * Requirements:
 ...
 *   We allocate a fixed stream size amount of memory in the module given in the
 * init. Each time we reach Block size we send a packet over the output device.
 *
 *
