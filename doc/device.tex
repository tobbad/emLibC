...
\item[\texttt{device\_read(hdl, buffer, cnt)} /
  \texttt{device\_write(hdl, buffer, cnt)}] Lesen bzw.\ schreiben über die
  Funktionszeiger des Geräts. Rückgabe: \verb|em_msg| (\verb|EM_ERR|, wenn das
  Gerät oder der jeweilige Zeiger fehlt).
