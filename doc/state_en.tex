...
\item[\texttt{state\_propagate(state, idx)}] Advances a key cyclically by one
  step and sets \emph{dirty} (also available as \verb|state_propagate_by_idx|
  / \verb|_by_lbl|). Returns: \verb|em_msg| (\verb|EM_ERR| on an invalid
