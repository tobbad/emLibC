...
\item[\texttt{state\_propagate(state, idx)}] Schaltet eine Taste zyklisch um
  einen Schritt weiter und setzt \emph{dirty} (auch als
  \verb|state_propagate_by_idx| / \verb|_by_lbl| verfügbar). Rückgabe:
